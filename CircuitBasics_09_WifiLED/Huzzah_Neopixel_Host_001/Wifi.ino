...
const String HtmlTitle = "<h1>Welcome to Huzzah NeoPixel</h1><br/>\n";
...
void handleRoot() { //on connection to IP root
 // Serial.println("Root page");
  String htmlRes = HtmlHtml + HtmlTitle + displayControl() + HtmlHtmlClose;
...
void wifiConfig(){
  ...
  Serial.println();
  Serial.print("Welcome to Huzzah Wifi, connect to IP:  ");
  Serial.println(apip);
